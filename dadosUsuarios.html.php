        ...
        <form id="aluno" method="POST" action="php/cadastrarAluno.php" enctype="multipart/form-data">
            <div class="row">
                <div class="input-field col s12 m9 l9">
                    ...
                    <input name="nome" id="nome_aluno" type="text" value="Teste" class="validate " readonly>
            ...
            <div class="row">
                <div class="input-field col s6 m4 l3">
                    ...
                    <input name="data_nascimento" id="data_nascimento" value="1994/09/27" type="text" class="validate"
                        readonly>
                    <label id="lbl">Data Nascimento</label>
                </div>
                <div class="input-field col s6 m4 l3">
                    <i class="material-icons prefix blue-icon">ballot</i>
                    <input name="ra" id="RA" placeholder="8956478-9" value="Teste" type="text" class="validate"
                        readonly>
                    <label id="lbl" for="first_name">RA</label>
                </div>
                <div class="input-field col s6 m4 l3">
                    <i class="material-icons prefix blue-icon">ballot</i>
                    <input name="rg" id="RG" value="Teste" type="tel" class="validate " readonly>
