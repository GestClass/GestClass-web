            ...
            <form id="aluno" method="POST" action="alteracaoDados.html.php" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="input-field col s6 m4 l5">
                        ...
                        <input name="data_nascimento" id="data_nascimento" value="<?php echo $dados_alunos["data_nascimento"] ?>" type="date" class="validate" readonly>
        ...
        <div class="container col s12 m12 l12 ">
            <form id="responsavel" method="POST" action="alteracaoDados.html.php" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="input-field col s6 m4 l4">
                        <i class="material-icons prefix blue-icon">cake</i>
                        <input name="nascimento_respon" id="data_nascimento" value="<?php echo $dados_resp['data_nascimento'] ?>" readonly type="date" class=" validate">
                        <label id="lbl">Data Nascimento</label>
                    </div>
                </div>
                <div class="row">
