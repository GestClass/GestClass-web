            ...
            <form id="aluno" method="POST" action="alteracaoDados.html.php" enctype="multipart/form-data">
                <div class="row">
                    <div class="input-field col s12 m9 l6">
                        ...
                        <input name="nome" id="nome_aluno" type="text" value="<?php echo $dados_alunos['nome_aluno'] ?>" class="validate " readonly>
                ...
                <div class="row">
                    <div class="input-field col s6 m4 l5">
                        ...
                        <input name="data_nascimento" id="data_nascimento" value="<?php echo date('d/m/Y', strtotime($dados_alunos["data_nascimento"]))?>" type="tel" class="validate" readonly>
                        <label id="lbl">Data Nascimento</label>
                    </div>
                    <div class="input-field col s6 m4 l5">
                        <i class="material-icons prefix blue-icon">ballot</i>
                        <input name="ra" id="RA" placeholder="8956478-9" value=<?php echo $dados_alunos['RA'] ?> data-mask="0000000-0" type="text" class="validate" readonly>
                    ...
                    <div class="input-field col s6 m6 l5">
                        <i class="material-icons prefix blue-icon">ballot</i>
                        <input name="cpf" id="CPF" value="<?php echo $dados_alunos['cpf'] ?>" type="text" class="validate " readonly>
                ...
                <div class="row">
                    <div class="input-field col s12 m4 l4">
                        ...
                        <input name="email" id="email" value="<?php echo $dados_alunos['email'] ?>" type="tel" class="validate " readonly>
                        <label id="lbl" for="first_name">Email</label>
                    </div>
                    <div class="input-field col s12 m6 l4">
                        <i class="material-icons prefix blue-icon">smartphone</i>
                        <input name="celular" id="celular" value="<?php echo $dados_alunos['celular'] ?>" type="tel" data-mask="(00) 00000-0000" class="validate " readonly>
                        <label id="lbl" for="first_name">Celular</label>
                    </div>
                    <div class="input-field col s12 m6 l4">
                        <i class="material-icons prefix blue-icon">call</i>
                        <input name="telefone" id="telefone" value="<?php echo $dados_alunos['telefone'] ?>" type="tel" data-mask="(00) 0000-0000" class="validate" readonly>
                ...
                <div class="row">
                    <div class="input-field col s12 m12 l2 validate">
                        ...
                        <input name="telefone" id="telefone" type="text" class="validate" value="<?php echo $dados_alunos['fk_id_turma_aluno'] ?>" readonly>
                ...
                <div class="col s12 m12 l12">
                    <div class="row">
                        <div class="input-field col s12 m9 l9">
                            <i class="material-icons prefix blue-icon">account_circle</i>
                            <input name="nome_respon" id="nome_responsavel" type="text" value="<?php echo $dados_resp['nome_responsavel'] ?>" readonly class="validate">
                    ...
                    <div class="row">
                        <div class="input-field col s6 m4 l4">
                            <i class="material-icons prefix blue-icon">ballot</i>
                            <input name="rg_respon" id="rg" type="tel" data-mask="00.000.000-0" value="<?php echo $dados_resp['RG'] ?>" readonly class="validate">
                            <label id="lbl" for="icon_telephone">RG</label>
                        </div>
                        <div class="input-field col s6 m4 l4">
                            <i class="material-icons prefix blue-icon">ballot</i>
                            <input name="cpf_respon" id="cpf" type="tel" value="<?php echo $dados_resp['cpf'] ?>" readonly data-mask="000.000.000-00" class="validate">
                            <label id="lbl" for="icon_telephone">CPF</label>
                        </div>
                        <div class="input-field col s6 m4 l4">
                            <i class="material-icons prefix blue-icon">cake</i>
                            <input name="nascimento_respon" id="data_nascimento" value="<?php echo date('d/m/Y', strtotime($dados_resp['data_nascimento'])) ?>" readonly type="date" class=" validate">
                            <label id="lbl">Data Nascimento</label>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div id="a" class="input-field col s10 m2 l2">
                            <input name="complemento" id="complemento" value="<?php echo $dados_resp['complemento'] ?>" readonly type="tel" class="validate ">
                            <label id="lbl" for="first_name">Complemento</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s12 m4 l5">
                            <i class="material-icons prefix blue-icon">alternate_email</i>
                            <input name="email_respon" id="email" type="tel" value="<?php echo $dados_resp['email'] ?>" readonly class="validate">
                            <label id="lbl" for="icon_telephone">Email</label>
                        </div>
                        <div class="input-field col s12 m4 l5">
                            <i class="material-icons prefix blue-icon">smartphone</i>
                            <input name="celular_respon" id="celular" type="tel" value="<?php echo $dados_resp['celular'] ?>" readonly data-mask="(00) 00000-0000" class="validate">
                            <label id="lbl" for="icon_telephone">Celular</label>
                        </div>
                        <div class="input-field col s12 m4 l5">
                            <i class="material-icons prefix blue-icon">call</i>
                            <input name="telefone_respon" id="telefone" type="tel" value="<?php echo $dados_resp['telefone'] ?>" readonly data-mask="(00) 0000-0000" class="validate">
                            <label id="lbl" for="icon_telephone">Telefone</label>
                        </div>
                        <div class="input-field col s12 m4 l5">
                            <i class="material-icons prefix blue-icon">call</i>
                            <input name="tel_comercial" id="telefone_comercial" type="tel" value="<?php echo $dados_resp['telefone_comercial'] ?>" readonly data-mask=" (00) 0000-0000" class="validate">
            ...
            <div class="container col s12 m12 l12 ">
                <form id="professor" method="POST" action="alteracaoDados.html.php" enctype="multipart/form-data">
                    <div class="row">
                        <div class="input-field col s12 m9 l9">
                            <i class="material-icons prefix blue-icon">account_circle</i>
                            <input name="nome" id="nome_professor" type="text" value="<?php echo $dados_prof['nome_professor'] ?>" readonly class=" validate">
                    ...
                    <div class="row">
                        <div class="input-field col s6 m4 l4">
                            <i class="material-icons prefix blue-icon">ballot</i>
                            <input name="rg" id="rg" value="<?php echo $dados_prof['rg'] ?>" readonly type="tel" class="validate">
                            <label id="lbl" for="icon_telephone">RG</label>
                        </div>
                        <div class="input-field col s6 m4 l4">
                            <i class="material-icons prefix blue-icon">ballot</i>
                            <input name="cpf" id="cpf" value="<?php echo $dados_prof['cpf'] ?>" readonly type="tel" class="validate">
                            <label id="lbl" for="icon_telephone">CPF</label>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div id="a" class="input-field col s10 m2 l3">
                            <input name="complemento" id="complemento" value="<?php echo $dados_prof['complemento'] ?>" readonly type="tel" class="validate ">
                            <label id="lbl" for="first_name">Complemento</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s12 m4 l4">
                            <i class="material-icons prefix blue-icon">alternate_email</i>
                            <input name="email" id="email" value="<?php echo $dados_prof['email'] ?>" readonly type="tel" class="validate">
                            <label id="lbl" for="icon_telephone">Email</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s12 m6 l4">
                            <i class="material-icons prefix blue-icon">smartphone</i>
                            <input name="celular" id="celular" value="<?php echo $dados_prof['celular'] ?>" readonly type="tel" data-mask="(00) 00000-0000" class="validate">
                            <label id="lbl" for="icon_telephone">Celular</label>
                        </div>
                        <div class="input-field col s12 m6 l4">
                            <i class="material-icons prefix blue-icon">call</i>
                            <input name="telefone" id="telefone" value="<?php echo $dados_prof['telefone'] ?>" readonly type="tel" data-mask="(00) 0000-0000" class="validate">
                            <label id="lbl" for="icon_telephone">Telefone</label>
                        </div>
                        <div>
        ...
        <div class="container col s12 m12 l12 ">
            <form id="secretaria" method="POST" action="alteracaoDados.html.php" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="input-field col s12 m9 l9">
                        <i class="material-icons prefix blue-icon">account_circle</i>
                        <input name="nome_secretario" id="nome_secretario" type="text" value="<?php echo $dados_sec['nome_secretario'] ?>" readonly class="validate">
                        <label id="lbl" for="icon_prefix">Nome</label>
                    </div>
                </div>
                <div class="row">
                    <div class="input-field col s6 m4 l4">
                        <i class="material-icons prefix blue-icon">ballot</i>
                        <input name="rg" id="rg" value="<?php echo $dados_sec['rg'] ?>" readonly type="tel" class="validate">
                        <label id="lbl" for="icon_telephone">RG</label>
                    </div>
                    <div class="input-field col s6 m4 l4">
                        <i class="material-icons prefix blue-icon">ballot</i>
                        <input name="cpf" id="cpf" value="<?php echo $dados_sec['cpf'] ?>" readonly type="tel" class="validate">
                        <label id="lbl" for="icon_telephone">CPF</label>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div id="a" class="input-field col s10 m2 l3">
                        <input name="complemento" id="complemento" value="<?php echo $dados_sec['complemento'] ?>" readonly type="tel" class="validate ">
                        <label id="lbl" for="first_name">Complemento</label>
                    </div>
                </div>
                <div class="row">
                    <div class="input-field col s12 m4 l4">
                        <i class="material-icons prefix blue-icon">alternate_email</i>
                        <input name="email" id="email" value="<?php echo $dados_sec['email'] ?>" readonly type="tel" class="validate">
                        <label id="lbl" for="icon_telephone">Email</label>
                    </div>
                </div>
                <div class="row">
                    <div class="input-field col s12 m6 l4">
                        <i class="material-icons prefix blue-icon">smartphone</i>
                        <input name="celular" id="celular" value="<?php echo $dados_sec['celular'] ?>" readonly type="tel" data-mask="(00) 00000-0000" class="validate">
                        <label id="lbl" for="icon_telephone">Celular</label>
                    </div>
                    <div class="input-field col s12 m6 l4">
                        <i class="material-icons prefix blue-icon">call</i>
                        <input name="telefone" id="telefone" value="<?php echo $dados_sec['telefone'] ?>" readonly type="tel" data-mask="(00) 0000-0000" class="validate">
                        <label id="lbl" for="icon_telephone">Telefone</label>
                    </div>
                    <div>
            ...
            <div class="container ">
                <form id="adicionarEscola" class="col s12" method="POST" action="alteracaoDados.html.php" enctype="multipart/form-data">
                    <div class="col s12 m12 l12">
                        ...
                        <div class="input-field col s12 m9 l9">
                            <i class="material-icons prefix blue-icon">account_circle</i>
                            <input id="icon_titulo" type="text" name="nome_diretor" id="nome_diretor" value="<?php echo $dados_dir['nome_diretor'] ?>" readonly class="validate">
                    ...
                    <div class="row">
                        <div class="input-field col s6 m4 l4">
                            <i class="material-icons prefix blue-icon">ballot</i>
                            <input name="rg" id="rg" value="<?php echo $dados_dir['rg'] ?>" readonly type="tel" class="validate">
                            <label id="lbl" for="icon_telephone">RG</label>
                        </div>
                        <div class="input-field col s6 m4 l4">
                            <i class="material-icons prefix blue-icon">ballot</i>
                            <input name="cpf" id="cpf" value="<?php echo $dados_dir['cpf'] ?>" readonly type="tel" class="validate">
                            <label id="lbl" for="icon_telephone">CPF</label>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div id="a" class="input-field col s10 m2 l3">
                            <input name="complemento" id="complemento" value="<?php echo $dados_dor['complemento'] ?>" readonly type="tel" class="validate ">
                            <label id="lbl" for="first_name">Complemento</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s12 m4 l4">
                            <i class="material-icons prefix blue-icon">alternate_email</i>
                            <input name="email" id="email" value="<?php echo $dados_dir['email'] ?>" readonly type="tel" class="validate">
                            <label id="lbl" for="icon_telephone">Email</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s12 m6 l4">
                            <i class="material-icons prefix blue-icon">smartphone</i>
                            <input name="celular" id="celular" value="<?php echo $dados_dir['celular'] ?>" readonly type="tel" data-mask="(00) 00000-0000" class="validate">
                            <label id="lbl" for="icon_telephone">Celular</label>
                        </div>
                        <div class="input-field col s12 m6 l4">
                            <i class="material-icons prefix blue-icon">call</i>
                            <input name="telefone" id="telefone" value="<?php echo $dados_dir['telefone'] ?>" readonly type="tel" data-mask="(00) 0000-0000" class="validate">
                            <label id="lbl" for="icon_telephone">Telefone</label>
                        </div>
                        <div>
