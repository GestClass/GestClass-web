...
<section class="floating-buttons">
    <div class="fixed-action-btn">
        ...
        <ul>
            ...
            <li><a href="#modalCadastroTurmas" class="modal-trigger btn-floating light-blue darken-4 tooltipped" data-position="left" data-tooltip="Cadastrar Turmas"><i class="material-icons">book</i></a></li>
