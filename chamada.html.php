...
<body>
    ...
    $id_turma_chamada = $_POST['id_turma'];
        ...
        <div class="container col s12 m12 l12" id="container_boletimCadastro">
            ...
            <div id="cadastroChamada" class="col s12 m12 l12">
                ...
                <form action="php/cadastroChamada.php" method="POST">
                    ...
                    <input type="hidden" name="idTurma" value="<?php echo $id_turma_chamada; ?>">
                    <div class="row">
                    ...
                    <table class="highlight centered">
                        ...
                        <tbody>
                            ...
                            $query_select_alunos = $conn->prepare("SELECT nome_aluno, RA FROM aluno WHERE fk_id_turma_aluno = $id_turma_chamada AND fk_id_escola_aluno = $id_escola");
