...
<body>
    ...
    $query_mensagem = $conn->prepare("SELECT nome_secretario,fk_recebimento_secretario_id_secretario,data_mensagem,assunto,mensagem
    ...
    <div id="modalEnviarTurma" class="modal modal-fixed-footer">
        <div class="modal-content">
            <h4>Nova Mensagem</h4><br>
            <div id="novaMensagem">
                <form action="php/enviarSecretariaTurmas.php" method="POST">
                    <div class="row">
    ...
    <div id="modalProfessor" class="modal modal-fixed-footer">
        <div class="modal-content">
            <h4>Nova Mensagem</h4><br>
            <div id="novaMensagem">
                <form action="php/enviarSecretariaProf.php" method="POST">
                    <div class="row">
                        <div class="input-field col s12 m4 l12">
                            <select name="destinatario">
                                <option value="" disabled selected></option>
    ...
    <div id="modalEnviarResponsavel" class="modal modal-fixed-footer">
        <div class="modal-content">
            <h4>Nova Mensagem</h4><br>
            <div id="novaMensagem">
                <form action="php/enviarSecretariaRespon.php" method="POST">
                    <div class="row">
                        <div class="col s12">
                            <div class="row">
                                <div class="input-field col s12">
    ...
    <div id="modalDiretor" class="modal modal-fixed-footer">
        <div class="modal-content">
            <h4>Nova Mensagem</h4><br>
            <div id="novaMensagem">
