                            ...
                            <div class="row">
                                <div class="input-field col s12 m6 l6">
                                    ...
                                    <input id="icon_titulo" type="text" name="nome_escola" id="nome_escola"
                                        class="validate" value="<?php echo $dados["nome_escola"]?>">
                            ...
                            <div class="row">
                                <div class="input-field col s6">
                                    ...
                                    <input data-mask="00000-000" placeholder="08574-310" name="cep" id="cep" type="text"
                                        class="validate" value="<?php echo $dados["cep"]?>">
                                ...
                                <div class="input-field col s4">
                                    <input placeholder="Complemento" name="complemento" id="complemento" type="text"
                                        class="validate" value="<?php echo $dados["complemento"]?>">
                            ...
                            <div class="row">
                                <div class="input-field col s12 m12 l12 ">
                                    ...
                                    <label for="icon_telephone">Quantidade Alunos
                                        <input type="range" id="qtd" min="0" max="5000" name="quantidade_alunos"
                                            value="<?php echo $dados["quantidade_alunos"]?>" /></label>
                                </div><br><br><br><br>
                                <div class="input-field col s12 m12 l12 ">
