...
<<<<<<< HEAD
                                ...
                                <div class="col s12 right-align">
                                    <button type="submit" class="btn-flat btn-large btnDark" name="btnCadastrar" value="aluno">Cadastrar aluno</button>
                                </div>
                            </form>
=======
                            </div>
...
>>>>>>> 1664e72b76d417a86a019be6444d07ebd0ca5ba4
                        </div>
...
<<<<<<< HEAD
                        <div id="responsavel" class="col s12">
                            <form action="" method="post">
                                ...
                                <div class="col s12 right-align">
                                    <button type="submit" class="btn-flat btn-large btnDark" name="btnCadastrar" value="resp">Cadastrar responsável</button>
                                </div>
                            </form>
=======
...
<<<<<<< HEAD
                        <div id="professor" class="col s12">
                            <form action="" method="post">
                                ...
                                <div class="input-field col s12 m6">
                                    <input class="inputDark" placeholder="Data de nascimento" name="nascresp" type="text"
                                        data-mask="00/00/0000">
                                </div>
                                <div class="col s12">
                                    <h5>Contato</h5>
                                ...
                                <div class="input-field col s12 m6">
                                    <input class="inputDark" placeholder="Telefone comercial" name="telcomresp" type="text"
                                        data-mask="(00) 0000-0000">
                                </div>
                                <div class="input-field col s12 m6">
                                    <input class="inputDark" placeholder="Email" name="emailresp" type="text">
                                ...
                                <div class="col s12 right-align">
                                    <button type="submit" class="btn-flat btn-large btnDark" name="btnCadastrar" value="resp">Cadastrar
                                        responsável</button>
                                </div>
                            </form>
=======
