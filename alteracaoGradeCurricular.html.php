...
<body class="body_estilizado">
    ...
    // Resgatando valores dos inputs hidden
    ...
    // Selecionar dados da grade curricular para verificar se existe registro cadastrado
    $select_registros_grade = $conn->prepare("SELECT * FROM  grade_curricular WHERE fk_id_dia_semana_grade_curricular = $id_dia AND fk_id_turma_grade_curricular = $id_turma");
    $select_registros_grade->execute();
    if ($select_registros_grade->rowCount()) {
    ...
    ?>
        ...
        <div class="container col s12 m12 l12" id="container_boletimCadastro">
            <div id="cadastro" class="col s12 m12 l12">
                <h3 class="center">Alteração de Grade Curricular</h3>
                <br>
                <hr>
                ...
                <form action="php/alteracaoGradeCurricular.php" method="POST">
                ...
                <form action="php/excluirGradeCurricular.php" method="POST">
                    <input type="hidden" name="idTurma" value="<?php echo $id_turma ?>">
                    <input type="hidden" name="idPadrao" value="<?php echo $id_padrao ?>">
                    <input type="hidden" name="idDia" value="<?php echo $id_dia ?>">
        ...
        ?>
            <script>
                alert('Nenhum registro cadastrado para esaa Turma nessa Data!!');
