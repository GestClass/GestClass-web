...
<section class="floating-buttons">
  <div class="fixed-action-btn">
    ...
    <ul>
      <li><a href="cadastroNovasDisciplinas.html.php" class="btn-floating green tooltipped" data-position="left" data-tooltip="Cadastrar Novas Disciplinas"><i class="material-icons">import_contacts</i></a></li>
      ...
      <li><a href="mensagensSecretaria.html.php" class="btn-floating blue-grey darken-4 tooltipped" data-position="left" data-tooltip="Envio de mensagens"><i class="material-icons">chat</i></a></li>
