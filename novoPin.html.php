    ...
    <div class="row">
      <div class="col l6 m8 s12 offset-l3 offset-m2">
        <div class="card-panel z-depth-5 formLogin animated fadeIn">
          <form action="php/novoPin.php" method="post" autocomplete="off">
            <h4 class="center">Redefinição do Código de Segurança</h4>
            <div class="input-field">
              <input name="email" type="email" placeholder="Digite seu email" class="inputDark">
            </div>
            <div class="input-field right-align">
              <input name="novoPin" type="password" placeholder="Digite o seu novo PIN" class="inputDark">
            </div>
            <div class="input-field right-align">
              <input name="confirmarPin" type="password" placeholder="Digite o seu novo PIN" class="inputDark">
            </div>
