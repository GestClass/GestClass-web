...
if (($mensagem != "") && ($assunto != "")) {
    ...
    if ($id_tipo_usuario == 1) {
        ...
        if ($usuario_tipo == 2) {
            ...
            //responder professor
            $inserirMensagem = $conn->prepare("INSERT INTO contato (mensagem, assunto, data_mensagem,notificacao, 
            fk_envio_secretario_id_secretario,fk_id_tipo_usuario_envio,fk_recebimento_professor_id_professor)
            VALUES (:mensagem, :assunto,  NOW(),'0',:id_usuario,:tipo_usuario,:destinatario)");
        ...
        if ($usuario_tipo == 2) {
            //responder diretor
            $inserirMensagem = $conn->prepare("INSERT INTO contato (mensagem, assunto, data_mensagem,notificacao, 
            fk_envio_professor_id_professor,fk_id_tipo_usuario_envio,fk_recebimento_diretor_id_diretor)
            VALUES (:mensagem, :assunto,  NOW(),'0',:id_usuario,:tipo_usuario,:destinatario)");
            ...
            //responder secretario
            $inserirMensagem = $conn->prepare("INSERT INTO contato (mensagem, assunto, data_mensagem,notificacao, 
            fk_envio_professor_id_professor,fk_id_tipo_usuario_envio,fk_recebimento_secretario_id_secretario)
            VALUES (:mensagem, :assunto,  NOW(),'0',:id_usuario,:tipo_usuario,:destinatario)");
        ...
        if ($usuario_tipo == 2) {
            //responder diretor
            $inserirMensagem = $conn->prepare("INSERT INTO contato (mensagem, assunto, data_mensagem,notificacao, 
            fk_envio_responsavel_id_responsavel,fk_id_tipo_usuario_envio,fk_recebimento_diretor_id_diretor)  
            VALUES (:mensagem, :assunto,  NOW(),'0',:id_usuario,:tipo_usuario,:destinatario)");
