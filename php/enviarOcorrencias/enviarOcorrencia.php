...
if (($ocorrencia != "") && ($assunto != "")) {
    ...
    $inserirOcorrencia = $conn->prepare("INSERT INTO contato (mensagem, assunto, data_mensagem,fk_id_tipo_usuario_envio, 
    ...
    VALUES (:ocorrencia, :assunto,  NOW(),:tipo_usuario, NULL,NULL,:id_usuario,NULL, NULL, NULL, NULL,:id_responsavel,NULL,NULL,NULL, NULL)");
